...
In logistic regression we investigated the behavior of the classification and compared it to that of SciKit Learn\cite{scikit-learn}. This gave the results found in figure \ref{fig:logreg-accuracy-sklearn-comparison}.
...
For classifying the states through a neural network, we looked at several different hyper parameters. First of, we start by comparing two different cost functions and their layer outputs,
\begin{itemize}
